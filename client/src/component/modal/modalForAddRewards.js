    ...
    return(
        ...
        <Center>
            ...
            <Center>
                <FormControl w="80%">
                    <Stack mb="5">
                        <FormControl.Label fontSize="16" opacity="0.7">Title</FormControl.Label>
                        <Controller 
                        control={control}
                    ...
                    <VStack mb="5">
                        <Text fontSize="16" opacity="0.7">Points</Text>
                        <Box mt="3"  borderRadius="10" p="5"  bg="white">
                            <Slider size="lg" defaultValue={0} onChange={sliderOnChange} onChangeEnd={sliderOnChangeEnd} videoRef={videoRef} maxValue={100}>
                        ...
                        <Text mt="2" color="cancelBtnGray" opacity="0.4" fontSize="11">Required Points</Text>
                    </VStack>


                    <VStack  mb="5">
                    <Text fontSize="16" opacity="0.7">Attached Photos/Video</Text>
                        <Center>
                    ...
                    <Stack mb="5">
                        <FormControl.Label fontSize="16" opacity="0.7">URL/Link</FormControl.Label>
                        <Controller 
                        control={control}
                        render={({ field: { onChange, onBlur, value } })=>(
                            <Input p={4} placeholder={"URL/Link"} borderRadius="10" 
                            onChangeText={onChange} value={value} bg="white"/>
                        )}
                        name = "url"
                        />
                    ...
                    <Stack mb="5">
                        ...
                        control={control}
                        render={({ field: { onChange, onBlur, value } })=>(
                            <TextArea p={2} placeholder="notes" borderRadius="10" height="150" onChangeText={onChange} value={value} bg="white" borderWidth="0"/>
